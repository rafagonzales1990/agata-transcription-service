...
import { FileAudio, Upload, TrendingUp, Clock, Zap, FolderOpen, Mic, Monitor, CloudUpload, Globe } from 'lucide-react';
      ...
      <div className="space-y-8">
        ...
        <div className="hidden lg:grid md:grid-cols-2 gap-4">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="rounded-xl border border-border bg-card p-5">
            ...
            <p className="text-xs text-muted-foreground mt-2 text-center">v1.0.15 · Sem instalação · Windows 10/11</p>
